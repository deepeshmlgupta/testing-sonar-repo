...
KEY_PD_VALUE = "SAP PD Value"
KEY_ERWIN_VALUE = "erwin Value"
...
def _build_dashboard(wb: Workbook, results: List, config) -> None:
    ...
    _populate_lowest_fidelity(ws, results, promo_start)
...
FINDINGS_HEADERS = [
    ...
    KEY_PD_VALUE, KEY_ERWIN_VALUE, "Recommended Action", "Manual Review",
]
...
AS_IMPORTED_HEADERS = [
    ...
    "Message", KEY_PD_VALUE, KEY_ERWIN_VALUE, "Repaired by preprocessing?",
]
...
MODEL_SHEET_HEADERS = [
    ...
    "Message", KEY_PD_VALUE, KEY_ERWIN_VALUE, "Recommended Action",
]
