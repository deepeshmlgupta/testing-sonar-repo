...
# Fix:
# Sonar read the banner rule above "Paths" as commented-out code. Swapped
# it for the same single-line header style already used for FOLDERS and
# REPORT NAMES higher up in this file, which it does not flag.
# ─── PATHS ────────────────────────────────────────────────────────────────────
